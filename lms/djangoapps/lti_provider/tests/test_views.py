...
class RenderCoursewareTest(TestCase):
    ...
    def setUp(self):
        ...
        self.render_mock = self.setup_patch('courseware.views.render_to_response', 'Rendered page')
        self.module_mock = self.setup_patch('courseware.views.get_module_by_usage_id', (self.module_instance, None))
        self.access_mock = self.setup_patch('courseware.views.has_access', 'StaffAccess')
        self.course_mock = self.setup_patch('courseware.views.get_course_with_access', 'CourseWithAccess')
